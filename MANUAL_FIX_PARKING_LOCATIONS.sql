-- MANUAL FIX FOR PARKING_LOCATIONS INFINITE RECURSION
...
-- Step 4: Also fix contractors table policies
DO $$
DECLARE pol RECORD;
BEGIN
  FOR pol IN (
...
-- Step 5: Fix attendants table policies
DO $$
DECLARE pol RECORD;
BEGIN
  FOR pol IN (
...
-- Step 6: Fix vehicles table policies
DO $$
DECLARE pol RECORD;
BEGIN
  FOR pol IN (
...
-- Step 7: Fix sessions table policies
DO $$
DECLARE pol RECORD;
BEGIN
  FOR pol IN (
